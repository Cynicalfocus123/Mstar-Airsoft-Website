    ...
    },
    {
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              title: 'FPS',
              table: {
                headers: ['ประเภท / บทบาท', 'น้ำหนัก BB'],
                rows: [
                  ['ปืนไรเฟิลทั่วไป / Assault', '0.25–0.32 กรัม'],
                  ['ปืนไรเฟิลสนาม / ระยะไกล', '0.28–0.32 กรัม'],
                  ['DMR', '0.32–0.40 กรัม'],
                  ['Sniper', '0.40–0.48+ กรัม'],
                ],
              },
              paragraphs: [
                'Force of Conquest ให้ใช้น้ำหนัก BB ที่นิยมใช้โดยทั่วไปมีประมาณนี้:',
                'Force of Conquest แนะนำให้ใช้ 0.28 หรือ 0.30 กรัม เป็นมาตรฐานสำหรับปืนไรเฟิลทั่วไป และอนุญาตให้ใช้ BB ที่หนักขึ้นสำหรับ DMR/Sniper ตามประเภทปืน',
              ],
              note: {
                label: 'ข้อสำคัญ:',
                text: 'กำหนดกำลังปืนเป็น Joule (J) มากกว่าใช้ FPS เพียงอย่างเดียว เพราะเมื่อเปลี่ยนน้ำหนัก BB ค่า FPS จะเปลี่ยนตามไปด้วย',
              },
            },
            {
              id: 'safety-protective-gear',
              title: 'ข้อกำหนดด้านความปลอดภัยและอุปกรณ์ป้องกัน',
              bullets: [
                'อุปกรณ์ป้องกันตาและใบหน้า: ผู้เล่นทุกคนต้องสวมแว่นตาป้องกันแบบ Full-seal ที่ได้มาตรฐาน ANSI (Z87.1 หรือเทียบเท่า) ผู้เข้าร่วมอายุต่ำกว่า 18 ปี และในบางกรณีผู้ใหญ่ตามข้อกำหนดของงาน ต้องสวมอุปกรณ์ป้องกันใบหน้าเต็มรูปแบบ',
                'ปลอกปิดลำกล้อง / Safety Sock: ปืนแอร์ซอฟต์ทุกกระบอกต้องติดตั้งอุปกรณ์ปิดกั้นลำกล้องที่ได้รับอนุมัติทุกครั้งเมื่ออยู่ในพื้นที่เตรียมตัว พื้นที่ปลอดภัย ลานจอดรถ และพื้นที่นอกเกม',
                'สิ่งของต้องห้าม: ห้ามนำอาวุธปืนจริง อาวุธที่มีกระสุนจริง มีดใบตาย วัตถุระเบิด และดอกไม้ไฟที่ไม่ได้รับอนุญาตเข้าภายในพื้นที่งานโดยเด็ดขาด',
                'หนังสือยินยอมรับผิดชอบ: ผู้เล่น ผู้ชม สื่อมวลชน และเจ้าหน้าที่ทุกคนต้องลงนามในหนังสือยินยอมรับผิดชอบอย่างเป็นทางการก่อนเข้าสู่พื้นที่ปฏิบัติการ',
              ],
            },
            {
              id: 'weapon-chronograph-regulations',
              title: 'ข้อบังคับปืนและการตรวจโครโนกราฟ',
              bullets: [
                'ขีดจำกัด FPS / Joule: ปืนแอร์ซอฟต์ทุกกระบอกต้องผ่านการตรวจโครโนกราฟโดยใช้ BB น้ำหนักเดียวกับที่จะใช้เล่นจริง ขีดจำกัดกำลังปืนกำหนดเป็น Joule เพื่อป้องกัน joule creep และอาจแตกต่างกันตามประเภทปืน เช่น ปืนไรเฟิล DMR หรือปืนสไนเปอร์',
                'ระยะยิงขั้นต่ำ (MED): ปืนกำลังสูงต้องปฏิบัติตามข้อกำหนดระยะยิงขั้นต่ำ ผู้เล่นที่ใช้ปืนสไนเปอร์หรือปืนความเร็วสูงต้องรักษาระยะยิงที่ปลอดภัย และเปลี่ยนไปใช้อาวุธรองหรือเรียก Bang Kill เมื่อต่อสู้ในระยะใกล้',
                'การยิงกึ่งอัตโนมัติ: เพื่อลดความเสี่ยงต่อการบาดเจ็บในระยะประชิด (CQB) ปืนส่วนใหญ่จำกัดให้ยิงกึ่งอัตโนมัติ อนุญาตให้ยิงอัตโนมัติเต็มรูปแบบเฉพาะปืนสนับสนุนที่ได้รับอนุมัติตามกติกาที่กำหนด',
              ],
            },
            {
              id: 'gameplay-field-rules',
              title: 'กติกาการเล่นและสนาม',
              bullets: [
                'ระบบเกียรติยศ: แอร์ซอฟต์ใช้ระบบเกียรติยศโดยสมบูรณ์ เมื่อ BB กระทบตัวผู้เล่น อุปกรณ์ หรือปืนโดยตรง ให้ถือว่าโดนยิงและถูกคัดออก',
                'ผ้าแดงสำหรับผู้ถูกคัดออก: ผู้เล่นที่ถูกคัดออกต้องแสดงผ้าแดงที่มองเห็นได้ทันทีบนศีรษะหรืออุปกรณ์ขณะกลับไปยังจุดเกิดใหม่หรือพื้นที่ปลอดภัย',
                'กติกา Medic และ Respawn: เกมบางรูปแบบอาจมีระบบแพทย์หรือชุบชีวิต ให้เพื่อนร่วมทีมชุบผู้เล่นที่ถูกคัดออกได้จำนวนจำกัดก่อนต้องกลับไปเกิดใหม่',
                'คำสั่งฉุกเฉิน Blind Man: คำว่า Blind Man ใช้เฉพาะกรณีฉุกเฉินจริง การบาดเจ็บ หรืออันตรายด้านความปลอดภัยเท่านั้น เมื่อได้ยินคำสั่งนี้ ผู้เล่นทุกคนต้องหยุดเล่นทันที ถอดแม็กกาซีนเมื่อได้รับคำสั่ง และรอคำแนะนำจากเจ้าหน้าที่งาน',
              ],
            },
            {
              id: 'player-conduct-event-policies',
              title: 'ความประพฤติของผู้เล่นและนโยบายงาน',
              bullets: [
                'อำนาจของกรรมการและเจ้าหน้าที่: กรรมการ มาร์แชล และผู้จัดงานมีอำนาจเต็มตลอดงาน การไม่ให้เกียรติ การใช้คำหยาบเกินควร การโกง การกระทำไม่ปลอดภัย หรือการโต้เถียงกับเจ้าหน้าที่ อาจทำให้ถูกเชิญออกจากงานทันทีโดยไม่คืนเงิน',
                'พื้นที่ปลอดภัยและพื้นที่เตรียมตัว: ห้ามยิง ห้ามทดลองยิง และห้ามใส่แม็กกาซีนที่บรรจุกระสุนในพื้นที่ปลอดภัยและพื้นที่เตรียมตัวที่กำหนด',
                'ความรับผิดชอบต่อสิ่งแวดล้อม: เพื่อปกป้องสิ่งแวดล้อมและรักษาความยั่งยืนของสนาม ขอแนะนำอย่างยิ่งให้ใช้ BB ย่อยสลายได้ และอาจเป็นข้อบังคับในพื้นที่กลางแจ้งที่กำหนด',
              ],
            },
            {
      ...
      sections: [
        ...
        },
        {
          ...
          title: 'FPS',
          paragraphs: [
            'For Airsoft MilSim, BB weights commonly fall into these ranges:',
            'Force of Conquest recommends using 0.28 g or 0.30 g as the practical standard for general rifle play, while allowing heavier BBs for DMR and sniper classes.',
          ],
          table: {
            headers: ['Role', 'Typical BB weight'],
            rows: [
              ['Standard rifle / assault', '0.25–0.32 g'],
              ['Outdoor rifle / longer range', '0.28–0.32 g'],
              ['DMR', '0.32–0.40 g'],
              ['Sniper', '0.40–0.48+ g'],
              ['Heavy precision BB', '0.45–0.50+ g'],
            ],
          },
          note: {
            label: 'Important:',
            text: 'Set the power limit in Joules, not FPS alone, because a gun’s FPS changes significantly with BB weight.',
          },
        },
        {
          id: 'safety-protective-gear',
