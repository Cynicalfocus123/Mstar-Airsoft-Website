...
import { getSafeInternalHref, getSafeLocalAssetPath, getSafeVideoUrl } from '../utils/safeUrl';
  ...
  return (
    <section className="banner-slider banner-video-hero" aria-label="Featured event">
      ...
      <div className="banner-overlay">
        <a className="btn btn-gold" href={getSafeInternalHref(activeSlide.cta.href)}>
